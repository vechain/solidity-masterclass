...
export interface XAllocationVotingGovernorMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
  ...
  encodeFunctionData(
    functionFragment: "setVotingPeriodInBlocks",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface XAllocationVotingGovernorMock extends BaseContract {
  connect(runner?: ContractRunner | null): XAllocationVotingGovernorMock;
  waitForDeployment(): Promise<this>;

  interface: XAllocationVotingGovernorMockInterface;
  ...
  setVotingPeriodInBlocks: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setVotingPeriodInBlocks"
  ): TypedContractMethod<
    [votingPeriodInBlocks: BigNumberish],
    [void],
    "nonpayable"
